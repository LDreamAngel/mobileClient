<template>
    <div class="listWarp" ref="list" @scroll="getMoreList()">
        ...
        <div v-if="noData">
            <div class="list" v-for="(item,index) in list" :key="index" @click="goSignUp(item.id)">
...
<script>
    import { getUserList } from '@/api/activity.js'
