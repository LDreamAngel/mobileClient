    ...
    <div class="comment">
        ...
        <section ref="list" @scroll="getMoreList()">
            <div class="listWarp">
                ...
                <div v-if="noData">
                    <div class="item" v-for="(item,index) in commentList" :key="index" v-if="noData" >
                        <div class="imgPic">
                            <img :src="item.insideUser.userInfo.avatar" alt="">
                        </div>
                        <div class="textPic">
                            <p class="textTop">{{item.insideUser.userInfo.userName}}:</p>
                            <div class="textMiddle" @click="goSignUp(item.aggregateId.aggregateId)" v-if="item.showMore">{{item.content}}</div>
                            <div class="textMiddle textMiddleMore"
                                 @click="goSignUp(item.aggregateId.aggregateId)"
                                 v-if="!item.showMore">{{item.content}}</div>
...
<script>
    import { getUserComment } from '@/api/activity.js'
